...
function Loginpage() {
    return (
     ...
     <section className=" bg-gray-50 text:bg-gray-900 w-1/5">
      <div className="ml 8 w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
      ...
      <img className="mt-0  ml-0 object-right h-96 w-96 object-hover " src="./assets/Logo.jpg" alt="" />  
      </a>
      </div>
      </div>
      </section>
              ...
              <form class="space-y-6 md:space-y-8" action="#">
                <div>
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Don’t have an account yet? <a href className="font-medium text-primary-600 hover:underline dark:text-primary-500">Create an acount</a>
                  </p>
                  </div>
