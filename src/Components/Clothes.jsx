...
Sort by 
  ...
  <div>
<div >
<h1 className=" ml-12 flex items-left text-lg font-bold truncate capitalize">Every Occassion </h1>
...
<a href="/">
    <img  className="ml-12 object-right h-48 w-48 object-hover " src="./pix/Gucci Playsuit Classy.png" alt="" />
</a>
...
<a href="/">
    <img  className="ml-14 object-right h-48 w-48 object-hover " src="./pix/Denim - Button-up.png" alt="" />
</a>

<div className="px-4 py-3">
  <span className="inline-flex">
<p className="mr-[49px] flex items-left text-lg font-bold truncate capitalize ">Denim - Button-up </p>
...
<a href="/">
    <img  className="ml-12 object-right h-48 w-48 object-hover " src="./pix/Dinner Dress.png" alt="" />
</a>
...
<a href="/">
    <img  className="ml-12 object-right h-48 object-hover " src="./pix/Body-con Skirt.png" alt="" />
</a>

<div className="px-4 py-3">
  <span className="inline-flex">
<p className="mr-[49px] flex items-left text-lg font-bold truncate capitalize "> Body-con Skirt</p>
...
<a href="/">
    <img  className="ml-20 object-right h-48 w-48 object-hover " src="./pix/Kimono.png" alt="" />
</a>
...
<a href="/">
    <img  className="ml-16 object-right h-48 w-48 object-hover " src="./pix/Crotchet top - matted.png" alt="" />
</a>

<div className="px-4 py-3">
  <span className="inline-flex">
<p className="mr-[49px] flex items-left text-lg font-bold truncate capitalize "> Crotchet top - matted </p>
